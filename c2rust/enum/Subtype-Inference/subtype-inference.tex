...
\begin{enumerate}
    ...
    \item Case where $\Gamma=\emptyset$ in the Theorem~\ref{thm:check-well-typed} and use Theorem~\ref{thm:check-apply}.
    \item Case where $\Gamma=\emptyset$ in the Theorem~\ref{thm:check-apply-force}.
\end{enumerate}
\end{proof}
